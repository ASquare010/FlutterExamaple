...
class ListViewCard extends StatefulWidget {
  ...
  ListViewCard({this.imageLink, this.price = 0, this.title = "Ice Zoo"});

  @override
  _ListViewCardState createState() => _ListViewCardState(this.imageLink, this.title, this.price);
}

class _ListViewCardState extends State<ListViewCard> {
  String link;

  _ListViewCardState(this.link, this._title, this._realPrice);

  double _locationRating = 3.5;
  int _amountOfRatings = 53, _realPrice = 102, _afterDiscountPrice = 65;
  bool _isTrending = true, _isDiscount = true;
  String _location = "Location of the Place", _title, _discription = "50-Min Cables Aqua Park";
          ...
          child: Center(
            child: Column(
              ...
              children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration:
                                    BoxDecoration(color: green.withOpacity(0.15), borderRadius: BorderRadius.circular(4)),
                                child: Text("\%${((_afterDiscountPrice / _realPrice) * 100).toInt()} OFF",
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 5,vertical: 2),
                  child: Text(_discription, style: TextStyle(color: darkGrey)),
                ),
              ],
            ),
          ),
